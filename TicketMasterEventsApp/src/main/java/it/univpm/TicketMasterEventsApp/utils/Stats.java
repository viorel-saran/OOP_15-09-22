...
public class Stats {
	...
	public static JSONObject getMinMaxMedEventi(List<Events> eventsOBJs) {
		...
		statsEventiMesi.put("Numero massimo di eventi mensili", maxCounters(countGen,countFeb,countMar,countApr,countMag,countGiu,countLug,countAgo,countSet,countOtt,countNov,countDec));
		statsEventiMesi.put("Numero minimo di eventi mensili", minCounters(countGen,countFeb,countMar,countApr,countMag,countGiu,countLug,countAgo,countSet,countOtt,countNov,countDec));
		statsEventiMesi.put("Numero medio di eventi mensili", mediaCounters(countGen,countFeb,countMar,countApr,countMag,countGiu,countLug,countAgo,countSet,countOtt,countNov,countDec));
